...
htmlhelp_basename = "text_chunk_parser_doc"
...
latex_documents = [
    (
        master_doc,
        "text_chunk_parser.tex",
        "text-chunk-parser Documentation",
        "Chad Lowe",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "text_chunk_parser", "text-chunk-parser Documentation", [author], 1)
]
